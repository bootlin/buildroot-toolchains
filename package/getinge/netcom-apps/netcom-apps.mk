...
NETCOM_APPS_DEPENDENCIES = netcom-cgic zlib

ifeq ($(BR2_PACKAGE_NETCOM_APPS_REMOTEAGENT),y)
...
NETCOM_APPS_BUILD_FLAGS = 		\
	...
	CFLAGS="$(TARGET_CFLAGS) -Wcast-align" 	\
	CXXFLAGS="$(TARGET_CXXFLAGS) -Wcast-align" 	\
...
define NETCOM_APPS_INSTALL_TARGET_CMDS
	...
	install -D -m 0755 package/getinge/netcom-apps/sntpdate.prestart \
		$(TARGET_DIR)/etc/init.d/sntpdate.prestart
